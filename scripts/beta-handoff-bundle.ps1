...
$bundleDir = Join-Path $reportsDir "beta-handoff-$timestamp"
...
try {
  & pwsh -File (Join-Path $PSScriptRoot "benchmark-evidence-scaffold.ps1") -OutputDir $bundleDir -Note "beta-handoff bundle" | Out-Null
...
$summary = @()
$summary += "# Replyline beta handoff bundle"
$summary += ""
...
$summary += "## Honesty"
$summary += ""
$summary += "- proves: local beta handoff packaging discipline on this workstation"
...
Write-Host "Beta handoff bundle created:" -ForegroundColor Green
