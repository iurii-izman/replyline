...
1. **Speech-to-text provider** (Deepgram). Receives WAV audio for transcription.
...
- **Configure providers**: Set Deepgram key for STT and choose LLM endpoint/model via the settings surface.
