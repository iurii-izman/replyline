...
- ContextPack — planned universal context primitive (см. [ADR 0001](adr/0001-context-pack-simplification.md)). Candidate Pack будет заменён.
...
- Candidate Pack будет заменён ContextPack (см. [ADR 0001](adr/0001-context-pack-simplification.md)). До замены: не формулировать Candidate Pack как глобальную память для всех режимов: по умолчанию это Interview Mode context.
...
- [benchmark-policy.md](benchmark-policy.md) - historical shorthand for the same claim labels.
