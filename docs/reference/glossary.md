...
- **context layer** — RAM ring buffer краткосрочного контекста между захватами. Это не shipped memory feature и не долгосрочное persistence-хранилище. Подробнее в [engineering/architecture.md](../engineering/architecture.md).
...
- **measured** — claim level: подтверждён runtime artifact, не теорией. Правила и границы доказательств описаны в [engineering/runtime.md](../engineering/runtime.md).
