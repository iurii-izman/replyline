...
- когда контекста не хватает, answer_now должен оставаться полезным: осторожный ответ + что нужно уточнить + безопасная формулировка, которую можно сказать сейчас
...
- when context is missing, answer_now must remain useful: cautious answer + what to clarify + a safe line the user can say now
