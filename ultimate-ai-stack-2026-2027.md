...
*Note: Cursor + Claude Code is listed for comparison but is evaluated fully in Category 4.*
...
*Note: This category is immature. All scores should be interpreted cautiously — these products are mostly 12–18 months old.*
...
*Note: Weighted scoring produces different orderings than the qualitative ranking in Phase 2 because it accounts for pricing, openness, and ecosystem — dimensions where open-source and cost-efficient models excel. GPT-5.4 leads on weighted score due to ecosystem breadth and integration depth, while Claude Opus leads on raw capability.*
...
*Note: Aider scores highly on weighted metrics due to being free, open-source, and flexible — despite lower raw capability than Cursor or Claude Code. For capability-weighted evaluation, Cursor and Claude Code lead.*
...
*End of report. Last updated: April 7, 2026.*
